import {domainDetails} from '../../../lib/core/getType.js';
//lib/core/getType
import {appendPrefxPath} from '../../../lib/core/cleanup.js';

import {getTypeof, isEmpty} from 'structkit';

import {setRequestParameter} from '../../../lib/http/request.js';

import {setRespondData} from '../../../lib/http/response.js';
