const {domainDetails, hostDetails} = require("./../lib/core/getType");
const {isHttps, isWSProtocolValid} = require("url-assist");
const {requestApi} = require("../lib/http/referenceRequest");
const {requestWSApi} = require("../lib/ws/referenceRequest");
const RequestsHttp = require("../structure/http/request_http");
const RequestsWs = require("../structure/ws/request_ws");
