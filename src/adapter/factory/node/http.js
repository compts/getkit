const {domainDetails} = require("../../../lib/core/getType");//lib/core/getType
const {appendPrefxPath} = require("../../../lib/core/cleanup");
const {getTypeof, isEmpty} = require("structkit");
const {setRequestParameter} = require("../../../lib/http/request");
const {setRespondData} = require("../../../lib/http/response");
