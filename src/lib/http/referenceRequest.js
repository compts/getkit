...
const adapterHttp = require('../../adapter/factory/node/http');
const adapterXhr = require('../../adapter/factory/browser/xhr');

const {getSegmentPath, getRequestDefaultConfig} = require("../../lib/core/getType");
